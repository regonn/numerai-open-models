...
try:
    ...
    def create_predict_function():
        ...
        def self_contained_predict(live_features_pd: pd.DataFrame) -> pd.DataFrame:
            ...
            # Make predictions
            predictions = captured_model.predict(dlive, iteration_range=(0, captured_model.best_iteration + 1))
    ...
    success_message = f"✅ **{NUMERAI_MODEL_ID}** training and submission completed successfully!\n💾 Model saved and uploaded to GCS\n📊 Predictions submitted to Numerai"
